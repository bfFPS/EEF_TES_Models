...
% order_data_PCS_historic = readtable(fullfile(user_path, 'Step 4 - Scenario Management\Inputs\...xlsx));
daily_scenarios_table = readtable(fullfile(user_path, 'Step 4 - Scenario Management\Inputs\scenarios_daily_values_29-Apr-2020.xlsx'));
...
%     numb_stores = length(unique(this_scenario_data.Store_ID));
    ...
    print(f,'-dpng','-r0',fullfile(user_path, strcat('Step 4 - Scenario Management\Outputs\scenario_', num2str(iSim), '_magnitude_desc_stats_.png')));
    close
...
%     legend('Scenario', 'Historical');
    ...
    print(f,'-dpng','-r0',fullfile(user_path, strcat('Step 4 - Scenario Management\Outputs\scenario_', num2str(iSim), '_normalise_desc_stats_.png')));
    close
