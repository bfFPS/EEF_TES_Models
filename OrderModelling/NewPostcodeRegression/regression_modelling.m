...
%     unique_districts = unique(this_PCS_rows.Country);
%     
%     this_district = strjoin(unique_districts, ', ');
%     this_country = strjoin(unique_districts, ', ');
%     
...
% 
% % save table
% writetable(ONS_stats_PCS, 'C:\Users\FPSScripting2\Documents\Consolidated_Models\OrderModelling\NewPostcodeRegression\Outputs\ONS_stats_PCS_V2.csv');
